...
curr_frame_id = 27
prev_frame_id = 26
pkl_path = './data/pkl/dusseldorf_000049.pkl'
prev_img_path = './data/pkl/dusseldorf_000049_0000' + str(prev_frame_id) + '_leftImg8bit.png'
curr_img_path = './data/pkl/dusseldorf_000049_0000' + str(curr_frame_id) + '_leftImg8bit.png'
